...
const API = axios.create({
  ...
  timeout: 15000, // Increase timeout to 15 seconds for slower connections
  headers: {
...
export const resetPassword = (data) => {
  ...
  return API.post("/users/reset-password", secureData);
};
...
export const disableTwoFactorAuth = (code) => {
  ...
  // Make sure the code is a string and properly trimmed
  const cleanedCode = String(code).trim();
  console.log("Cleaned 2FA disable code:", cleanedCode);
